...
import static gjum.minecraft.mapsync.common.utilities.Shortcuts.MINECRAFT;
...
public class JourneyMapHelperReal {
	...
	static boolean updateWithChunkTile(ChunkTile chunkTile) {
		...
		var rCoord = RegionCoord.fromChunkPos(
				FileHandler.getJMWorldDir(MINECRAFT),
	...
	private static class TileChunkMD extends NBTChunkMD {
		...
		public TileChunkMD(ChunkTile chunkTile) {
			super(new LevelChunk(MINECRAFT.level, chunkTile.chunkPos()),
					chunkTile.chunkPos(),
